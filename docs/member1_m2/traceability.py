...
def render(root):
    ...
    <h1>CivicConnect requirements traceability</h1><p>The supplied PED v2.0 is approved. Product implementation and test acceptance are recorded separately. This working update adds evidence checks; it does not imply all product requirements are implemented.</p>
